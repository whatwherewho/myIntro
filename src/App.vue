  ...
  data(){
    return{
      ...
      arr:[{
        ...
        next:true,
        prev:false,
        content:["喜欢听音乐，玩游戏，看动画。","性格较为开朗，在独自想东西的时候经常会不由自主因为自己想的东西而轻轻笑起来。从小被形容为爱笑的人。","有时会在一些奇怪的地方有奇怪的记忆力。","在大学期间曾经帮助一个国内的网站“灰机wiki”上的地下城与勇士维基站点的编辑。现在该站点能从dnf官网首页进入。<br />附上链接：https://dnfcn.huijiwiki.com/wiki/%E9%A6%96%E9%A1%B5"]
      },{
        id:2,
        title:'爱听音乐',
        next:true,
        ...
        },
        {
          ...
          next:false,
          prev:true,
          content:["在2016年6月左右，由于在一个dnf相关贴吧看到了一个征求帮忙编辑地下城与勇士维基站资料的内容，我便自行前去帮忙。在随后的半年间一直帮忙整理各种各样的资料，帮忙完善该站点，该站点已经于2017年1月登陆了腾讯地下城与勇士游戏官网首页。在编辑期间我虽然主要以完善资料为主，但也接触了一些html和css相关的内容，因此产生了一些前端相关的兴趣。","在帮助该站点进行最初的完善的过程中，我有把握说我是付出努力最多的站外人员，在当时一度编辑数达到第一，即便是在现在，依然排在第二（第一为该网站该站点的负责人），不过当时与其他参与的人们联系时，使用的是另外一个QQ号：775738865。","最后再次附上链接：https://dnfcn.huijiwiki.com/wiki/%E9%A6%96%E9%A1%B5，也可以从dnf官网的“资料百科”处进入。"]
        }]
    }
  },
  components:{
